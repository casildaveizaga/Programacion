...
public class TanqueAgua{
    ...
    public void vaciarCertaAgua(double capacidadAgua){
           if(capacidadAgua > cantidad ){
              ingresar = 0;
            }else{
               this.ingresar = ingresar - capacidadAgua;
            }
    }
    ...
    public void estado (){
        ...
        }else if (ingresar ==cantidad){
           System.out.println ("lleno");
        }else{
         System.out.println ("con agua");
        }
    }
}