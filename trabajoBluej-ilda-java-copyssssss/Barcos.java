...
public class Barcos{
    ...
    public Barcos (int nroLiberarDeSaqueadores,int nroBuscarDesaparecidos, int nroRecolectarAlimentos) {
    ...
    public void misionAlazar(){
        ...
        if (cualquierMision == 1){
            ...
            totalGanado = this.totalGanado + precioLiberarDeSaqueadores;
            calcularRiesgo();
        }else if (cualquierMision == 2){
            System.out.println ("buscar desaparecidos");
            totalGanado = this.totalGanado + precioBuscarDesaparecidos;
            calcularRiesgo();
        }else{
            System.out.println ("recolectar alimentos");
            totalGanado = this.totalGanado + precioRecolectarAlimentos;
            calcularRiesgo();
        }
    }
    ...
    public void calcularRiesgo(){
        ...
        if (muereTripulante <= 10){
            nroTripulantes = this.nroTripulantes - 1;
        }else{}
    }
